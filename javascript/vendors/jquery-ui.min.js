...
/*
 * ! jQuery UI Widget 1.10.3 http://jqueryui.com
 * 
            ...
            if (isMethodCall) {
                this
                        .each(function() {
                            ...
                            if (!instance) {
                                return $.error("cannot call methods on " + name + " prior to initialization; " + "attempted to call method '"
                                        + options + "'");
                            }
...
/*
 * ! jQuery UI Mouse 1.10.3 http://jqueryui.com
 * 
 * Copyright 2013 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
...
/*
 * ! jQuery UI Draggable 1.10.3 http://jqueryui.com
 * 
 * Copyright 2013 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
    ...
    $
            .widget("ui.draggable", $.ui.mouse, {
                ...
                _mouseStop : function(event) {
                    ...
                    // if the original element is no longer in the DOM don't
                    // bother to continue (see #8269)
                ...
                _createHelper : function(event) {
                    ...
                    var o = this.options, helper = $.isFunction(o.helper) ? $(o.helper.apply(this.element[0], [ event ])) : (o.helper === "clone" ? this.element
                ...
                _setContainment : function() {
                    ...
                    this.containment = [
                            ...
                            (over ? Math.max(ce.scrollWidth, ce.offsetWidth) : ce.offsetWidth) - (parseInt(c.css("borderRightWidth"), 10) || 0)
                                    - (parseInt(c.css("paddingRight"), 10) || 0) - this.helperProportions.width - this.margins.left
                                    - this.margins.right,
                            (over ? Math.max(ce.scrollHeight, ce.offsetHeight) : ce.offsetHeight) - (parseInt(c.css("borderBottomWidth"), 10) || 0)
                                    - (parseInt(c.css("paddingBottom"), 10) || 0) - this.helperProportions.height - this.margins.top
                                    - this.margins.bottom ];
                ...
                _convertPositionTo : function(d, pos) {
                    ...
                    var mod = d === "absolute" ? 1 : -1, scroll = this.cssPosition === "absolute"
                            && !(this.scrollParent[0] !== document && $.contains(this.scrollParent[0], this.offsetParent[0])) ? this.offsetParent : this.scrollParent;
                ...
                _generatePosition : function(event) {
                    ...
                    var containment, co, top, left, o = this.options, scroll = this.cssPosition === "absolute"
                            && !(this.scrollParent[0] !== document && $.contains(this.scrollParent[0], this.offsetParent[0])) ? this.offsetParent : this.scrollParent, pageX = event.pageX, pageY = event.pageY;
                    ...
                    if (this.originalPosition) {
                        if (this.containment) {
                            if (this.relative_container) {
                                ...
                                containment = [ this.containment[0] + co.left, this.containment[1] + co.top, this.containment[2] + co.left,
                ...
                _trigger : function(type, event, ui) {
                    ...
                    // The absolute position has to be recalculated after
                    // plugins
                    if (type === "drag") {
                        this.positionAbs = this._convertPositionTo("absolute");
                    }
...
/*
 * ! jQuery UI Droppable 1.10.3 http://jqueryui.com
 * 
 * Copyright 2013 jQuery Foundation and other contributors Released under the
 * MIT license. http://jquery.org/license
 * 
    ...
    $.ui.ddmanager = {
        ...
        drag : function(draggable, event) {
            ...
            $.each($.ui.ddmanager.droppables[draggable.options.scope] || [], function() {
                ...
                var parentInstance, scope, parent, intersects = $.ui.intersect(draggable, this, this.options.tolerance), c = !intersects
